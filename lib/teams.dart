...
enum Team {
  ...
  toronto("Toronto", "Toonies", "TOR", TeamDivision.alEast, Colors.lightBlueAccent, Colors.brown),
  montreal("Montreal", "Monarchs", "MON", TeamDivision.nlEast, Colors.red, Colors.green),
